...
public class PrestamosPrototype implements Prototype<PrestamosPrototype>{
    ...
    @Override
    public PrestamosPrototype clone() {
       PrestamosPrototype cloned = new PrestamosPrototype();
       cloned.setCod_libro(this.cod_libro);
       cloned.setCod_prestamo(this.cod_prestamo);
       cloned.setDni(this.dni);
       cloned.setFec_pres(this.fec_pres);
       cloned.setFec_devo(this.fec_devo);
       return cloned;
    }
}
