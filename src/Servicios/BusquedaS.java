...
public class BusquedaS {
  public ArrayList<Editorial> buscarEditorial(String nombre, ArrayList<Editorial> editoriales) {
     ...
     public ArrayList<EditorialAF> buscarEditorialAF(String nombre, ArrayList<EditorialAF> editoriales) {
        ArrayList<EditorialAF> resultados = new ArrayList<>();
        for (EditorialAF ed : editoriales) {
            if (ed.getNom_editorial().toLowerCase().contains(nombre.toLowerCase())) {
                resultados.add(ed);
            }
        }
