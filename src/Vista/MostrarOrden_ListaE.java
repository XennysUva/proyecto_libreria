 ...
 * @author leslie
 */
public class MostrarOrden_ListaE extends javax.swing.JFrame {

    ListaEnlazada lista;
    
    public MostrarOrden_ListaE() {
        initComponents();
    ...
    if(lista.getInicio()== null){
            ...
            while(elemento != null){
                txtA.append(elemento.getEditorial().getCod_editorial()+ "-->");
    ...
    private void initComponents() {
        ...
        setTitle("Mostrar Orden - Lista Enlazada");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarOrden_ListaE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarOrden_ListaE().setVisible(true);
            }
        });
    }
